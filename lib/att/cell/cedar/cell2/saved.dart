...
class CedarC2Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  CedarC2Saved(this.sharedPreferencesManager);

  @override
  _CedarC2SavedState createState() => _CedarC2SavedState();
}

class _CedarC2SavedState extends State<CedarC2Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'CedarC2-$fileName-$currentDate.starx';
