...
class CedarC2 extends StatelessWidget {
  final SharedPreferencesManager sharedPreferencesManager =
  SharedPreferencesManager('CedarC2');
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          CedarC2Saved(widget.sharedPreferencesManager),
                    ),
                  );
                },
                style: ButtonStyle(
...
// Function to save the manually entered matriculation number
  ...
  Future<void> generateExcelAndShare(List<ScanResult> scanResults,
    ...
    Sheet sheetObject = excel['CedarC2'];
    ...
    if (encoded!.isNotEmpty) {
      try {
        ...
        final String fileName = 'CedarC2.starx';
