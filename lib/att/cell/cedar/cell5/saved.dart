...
class CedarC5Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  CedarC5Saved(this.sharedPreferencesManager);

  @override
  _CedarC5SavedState createState() => _CedarC5SavedState();
}

class _CedarC5SavedState extends State<CedarC5Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'CedarC5-$fileName-$currentDate.starx';
