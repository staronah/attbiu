...
class CedarC1Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  CedarC1Saved(this.sharedPreferencesManager);

  @override
  _CedarC1SavedState createState() => _CedarC1SavedState();
}

class _CedarC1SavedState extends State<CedarC1Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'CedarC1-$fileName-$currentDate.starx';
