...
class CedarC3Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  CedarC3Saved(this.sharedPreferencesManager);

  @override
  _CedarC3SavedState createState() => _CedarC3SavedState();
}

class _CedarC3SavedState extends State<CedarC3Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'CedarC3-$fileName-$currentDate.starx';
