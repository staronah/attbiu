...
class CedarC4Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  CedarC4Saved(this.sharedPreferencesManager);

  @override
  _CedarC4SavedState createState() => _CedarC4SavedState();
}

class _CedarC4SavedState extends State<CedarC4Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'CedarC4-$fileName-$currentDate.starx';
