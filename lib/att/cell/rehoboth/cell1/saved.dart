...
class RehobothC1Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  RehobothC1Saved(this.sharedPreferencesManager);

  @override
  _RehobothC1SavedState createState() => _RehobothC1SavedState();
}

class _RehobothC1SavedState extends State<RehobothC1Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'RehobothC1-$fileName-$currentDate.starx';
