...
class RehobothC2Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  RehobothC2Saved(this.sharedPreferencesManager);

  @override
  _RehobothC2SavedState createState() => _RehobothC2SavedState();
}

class _RehobothC2SavedState extends State<RehobothC2Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'RehobothC2-$fileName-$currentDate.starx';
