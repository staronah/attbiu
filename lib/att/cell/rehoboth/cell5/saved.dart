...
class RehobothC5Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  RehobothC5Saved(this.sharedPreferencesManager);

  @override
  _RehobothC5SavedState createState() => _RehobothC5SavedState();
}

class _RehobothC5SavedState extends State<RehobothC5Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'RehobothC5-$fileName-$currentDate.starx';
