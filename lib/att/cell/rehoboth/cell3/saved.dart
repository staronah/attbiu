...
class RehobothC3Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  RehobothC3Saved(this.sharedPreferencesManager);

  @override
  _RehobothC3SavedState createState() => _RehobothC3SavedState();
}

class _RehobothC3SavedState extends State<RehobothC3Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'RehobothC3-$fileName-$currentDate.starx';
