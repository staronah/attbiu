...
class RehobothC3 extends StatelessWidget {
  final SharedPreferencesManager sharedPreferencesManager =
  SharedPreferencesManager('RehobothC3');
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          RehobothC3Saved(widget.sharedPreferencesManager),
                    ),
                  );
                },
                style: ButtonStyle(
...
// Function to save the manually entered matriculation number
  ...
  Future<void> generateExcelAndShare(List<ScanResult> scanResults,
    ...
    Sheet sheetObject = excel['RehobothC3'];
    ...
    if (encoded!.isNotEmpty) {
      try {
        ...
        final String fileName = 'RehobothC3.starx';
