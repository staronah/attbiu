...
class RehobothC4Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  RehobothC4Saved(this.sharedPreferencesManager);

  @override
  _RehobothC4SavedState createState() => _RehobothC4SavedState();
}

class _RehobothC4SavedState extends State<RehobothC4Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'RehobothC4-$fileName-$currentDate.starx';
