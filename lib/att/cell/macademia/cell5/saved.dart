...
class MacedemiaC5Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  MacedemiaC5Saved(this.sharedPreferencesManager);

  @override
  _MacedemiaC5SavedState createState() => _MacedemiaC5SavedState();
}

class _MacedemiaC5SavedState extends State<MacedemiaC5Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'MacedemiaC5-$fileName-$currentDate.starx';
