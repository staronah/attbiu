...
class MacedemiaC1Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  MacedemiaC1Saved(this.sharedPreferencesManager);

  @override
  _MacedemiaC1SavedState createState() => _MacedemiaC1SavedState();
}

class _MacedemiaC1SavedState extends State<MacedemiaC1Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'MacedemiaC1-$fileName-$currentDate.starx';
