...
class MacedemiaC4Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  MacedemiaC4Saved(this.sharedPreferencesManager);

  @override
  _MacedemiaC4SavedState createState() => _MacedemiaC4SavedState();
}

class _MacedemiaC4SavedState extends State<MacedemiaC4Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'MacedemiaC4-$fileName-$currentDate.starx';
