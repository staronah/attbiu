...
class MacedemiaC2Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  MacedemiaC2Saved(this.sharedPreferencesManager);

  @override
  _MacedemiaC2SavedState createState() => _MacedemiaC2SavedState();
}

class _MacedemiaC2SavedState extends State<MacedemiaC2Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'MacedemiaC2-$fileName-$currentDate.starx';
