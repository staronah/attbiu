...
class MacedemiaC3Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  MacedemiaC3Saved(this.sharedPreferencesManager);

  @override
  _MacedemiaC3SavedState createState() => _MacedemiaC3SavedState();
}

class _MacedemiaC3SavedState extends State<MacedemiaC3Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'MacedemiaC3-$fileName-$currentDate.starx';
