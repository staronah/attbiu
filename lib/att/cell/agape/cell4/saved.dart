...
class AgapeC4Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  AgapeC4Saved(this.sharedPreferencesManager);

  @override
  _AgapeC4SavedState createState() => _AgapeC4SavedState();
}

class _AgapeC4SavedState extends State<AgapeC4Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'AgapeC4-$fileName-$currentDate.starx';
