...
class AgapeC4 extends StatelessWidget {
  final SharedPreferencesManager sharedPreferencesManager =
  SharedPreferencesManager('AgapeC4');
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          AgapeC4Saved(widget.sharedPreferencesManager),
                    ),
                  );
                },
                style: ButtonStyle(
...
// Function to save the manually entered matriculation number
  ...
  Future<void> generateExcelAndShare(List<ScanResult> scanResults,
    ...
    Sheet sheetObject = excel['AgapeC4'];
    ...
    if (encoded!.isNotEmpty) {
      try {
        ...
        final String fileName = 'AgapeC4.starx';
