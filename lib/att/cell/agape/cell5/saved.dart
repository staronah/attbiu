...
class AgapeC5Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  AgapeC5Saved(this.sharedPreferencesManager);

  @override
  _AgapeC5SavedState createState() => _AgapeC5SavedState();
}

class _AgapeC5SavedState extends State<AgapeC5Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'AgapeC5-$fileName-$currentDate.starx';
