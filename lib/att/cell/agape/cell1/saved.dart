...
class AgapeC1Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  AgapeC1Saved(this.sharedPreferencesManager);

  @override
  _AgapeC1SavedState createState() => _AgapeC1SavedState();
}

class _AgapeC1SavedState extends State<AgapeC1Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'AgapeC1-$fileName-$currentDate.starx';
