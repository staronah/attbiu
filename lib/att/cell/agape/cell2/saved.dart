...
class AgapeC2Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  AgapeC2Saved(this.sharedPreferencesManager);

  @override
  _AgapeC2SavedState createState() => _AgapeC2SavedState();
}

class _AgapeC2SavedState extends State<AgapeC2Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'AgapeC2-$fileName-$currentDate.starx';
