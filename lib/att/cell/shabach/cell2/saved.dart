...
class ShabachC2Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  ShabachC2Saved(this.sharedPreferencesManager);

  @override
  _ShabachC2SavedState createState() => _ShabachC2SavedState();
}

class _ShabachC2SavedState extends State<ShabachC2Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'ShabachC2-$fileName-$currentDate.starx';
