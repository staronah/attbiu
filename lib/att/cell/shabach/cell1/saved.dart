...
class ShabachC1Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  ShabachC1Saved(this.sharedPreferencesManager);

  @override
  _ShabachC1SavedState createState() => _ShabachC1SavedState();
}

class _ShabachC1SavedState extends State<ShabachC1Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'ShabachC1-$fileName-$currentDate.starx';
