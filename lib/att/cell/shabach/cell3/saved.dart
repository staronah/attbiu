...
class ShabachC3Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  ShabachC3Saved(this.sharedPreferencesManager);

  @override
  _ShabachC3SavedState createState() => _ShabachC3SavedState();
}

class _ShabachC3SavedState extends State<ShabachC3Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'ShabachC3-$fileName-$currentDate.starx';
