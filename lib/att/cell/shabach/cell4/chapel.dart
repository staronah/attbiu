...
class ShabachC4 extends StatelessWidget {
  final SharedPreferencesManager sharedPreferencesManager =
  SharedPreferencesManager('ShabachC4');
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          ShabachC4Saved(widget.sharedPreferencesManager),
                    ),
                  );
                },
                style: ButtonStyle(
...
// Function to save the manually entered matriculation number
  ...
  Future<void> generateExcelAndShare(List<ScanResult> scanResults,
    ...
    Sheet sheetObject = excel['ShabachC4'];
    ...
    if (encoded!.isNotEmpty) {
      try {
        ...
        final String fileName = 'ShabachC4.starx';
