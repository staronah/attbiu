...
class ShabachC4Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  ShabachC4Saved(this.sharedPreferencesManager);

  @override
  _ShabachC4SavedState createState() => _ShabachC4SavedState();
}

class _ShabachC4SavedState extends State<ShabachC4Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'ShabachC4-$fileName-$currentDate.starx';
