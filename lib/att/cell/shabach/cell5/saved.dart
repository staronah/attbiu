...
class ShabachC5Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  ShabachC5Saved(this.sharedPreferencesManager);

  @override
  _ShabachC5SavedState createState() => _ShabachC5SavedState();
}

class _ShabachC5SavedState extends State<ShabachC5Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'ShabachC5-$fileName-$currentDate.starx';
