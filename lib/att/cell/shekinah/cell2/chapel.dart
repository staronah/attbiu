...
class ShekinahC2 extends StatelessWidget {
  final SharedPreferencesManager sharedPreferencesManager =
  SharedPreferencesManager('ShekinahC2');
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          ShekinahC2Saved(widget.sharedPreferencesManager),
                    ),
                  );
                },
                style: ButtonStyle(
...
// Function to save the manually entered matriculation number
  ...
  Future<void> generateExcelAndShare(List<ScanResult> scanResults,
    ...
    Sheet sheetObject = excel['ShekinahC2'];
    ...
    if (encoded!.isNotEmpty) {
      try {
        ...
        final String fileName = 'ShekinahC2.starx';
