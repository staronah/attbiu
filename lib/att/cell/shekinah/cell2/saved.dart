...
class ShekinahC2Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  ShekinahC2Saved(this.sharedPreferencesManager);

  @override
  _ShekinahC2SavedState createState() => _ShekinahC2SavedState();
}

class _ShekinahC2SavedState extends State<ShekinahC2Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'ShekinahC2-$fileName-$currentDate.starx';
