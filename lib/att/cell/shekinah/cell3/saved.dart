...
class ShekinahC3Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  ShekinahC3Saved(this.sharedPreferencesManager);

  @override
  _ShekinahC3SavedState createState() => _ShekinahC3SavedState();
}

class _ShekinahC3SavedState extends State<ShekinahC3Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'ShekinahC3-$fileName-$currentDate.starx';
