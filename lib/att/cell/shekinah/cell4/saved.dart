...
class ShekinahC4Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  ShekinahC4Saved(this.sharedPreferencesManager);

  @override
  _ShekinahC4SavedState createState() => _ShekinahC4SavedState();
}

class _ShekinahC4SavedState extends State<ShekinahC4Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'ShekinahC4-$fileName-$currentDate.starx';
