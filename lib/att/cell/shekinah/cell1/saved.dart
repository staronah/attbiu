...
class ShekinahC1Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  ShekinahC1Saved(this.sharedPreferencesManager);

  @override
  _ShekinahC1SavedState createState() => _ShekinahC1SavedState();
}

class _ShekinahC1SavedState extends State<ShekinahC1Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'ShekinahC1-$fileName-$currentDate.starx';
