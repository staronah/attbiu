...
class ShekinahC5Saved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  ShekinahC5Saved(this.sharedPreferencesManager);

  @override
  _ShekinahC5SavedState createState() => _ShekinahC5SavedState();
}

class _ShekinahC5SavedState extends State<ShekinahC5Saved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'ShekinahC5-$fileName-$currentDate.starx';
