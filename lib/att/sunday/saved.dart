...
class SundaySaved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  SundaySaved(this.sharedPreferencesManager);

  @override
  _SundaySavedState createState() => _SundaySavedState();
}

class _SundaySavedState extends State<SundaySaved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'Sunday-$fileName-$currentDate.starx';
