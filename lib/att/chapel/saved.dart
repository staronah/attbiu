...
class ChapelSaved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  ChapelSaved(this.sharedPreferencesManager);

  @override
  _ChapelSavedState createState() => _ChapelSavedState();
}

class _ChapelSavedState extends State<ChapelSaved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'Chapel-$fileName-$currentDate.starx';
