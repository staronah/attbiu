...
class CFI extends StatelessWidget {
  final SharedPreferencesManager sharedPreferencesManager =
  SharedPreferencesManager('CFI');
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          CFISaved(widget.sharedPreferencesManager),
                    ),
                  );
                },
                style: ButtonStyle(
  ...
  Future<void> generateExcelAndShare(List<ScanResult> scanResults,
    ...
    if (encoded!.isNotEmpty) {
      try {
        ...
        final String fileName = 'CFI.starx';
