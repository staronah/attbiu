...
class CFISaved extends StatefulWidget {
  final SharedPreferencesManager sharedPreferencesManager;

  CFISaved(this.sharedPreferencesManager);

  @override
  _CFISavedState createState() => _CFISavedState();
}

class _CFISavedState extends State<CFISaved> {
                ...
                if (fileName.isNotEmpty) {
                  ...
                  if (excelBytes != null) {
                    try {
                      ...
                      final String fileNameWithDate = 'CFI-$fileName-$currentDate.starx';
